...
DigiFiUSARTClass::DigiFiUSARTClass( Usart* pUsart, IRQn_Type dwIrq, uint32_t dwId, DigiFiRingBuffer* pRx_buffer )
{
...
int DigiFiUSARTClass::read( void )
{
...
void DigiFiUSARTClass::flush( void )
{
...
size_t DigiFiUSARTClass::write( const uint8_t uc_data )
{
...
{   
    ...
    else if(avail < DIGIFI_SERIAL_BUFFER_SIZE - 64 && cts==HIGH)
    {
...
void DigiFiUSARTClass::IrqHandler( void )
{
